...
* **Design System:** When creating or modifying UI components, you MUST first read the `DESIGN.md` file located at docs folder to ensure all spacing, colors, and typography strictly follow the project's design system.
